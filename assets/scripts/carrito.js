	...
	app.masVendidos = function(){
		var productos = [
			{
				...
				name : 'Demon Slayer: Kimetsu No Yaiba Kamado ',
				price : 299.00,
				desc : 'Cosplay Puedes comprarlo con paypal y tarjeta',
				stock : 4
			},
			{
				id : 2,
				name : 'cosplay yoshiba',
			...
			id : 3,
			name : 'cosplay yoshiba',
			img : '/Carrito-de-compras-con-HTML5-CSS3-y-JS-master/assets/img/mochila.jpg',
			price : 199.00,
			desc : 'Cosplay Puedes comprarlo con paypal y tarjeta',
			stock : 2
		},
			...
			{
				id : 5,
				name : 'Figura Goku Dragon ball',
				img : 'assets/img/bravia.jpg',
				price : 85.00,
				desc : ' figuraPuedes comprarlo con paypal y tarjeta',
				stock : 4
			},
			{
				id : 6,
				name : 'spider woman black Cosplay',
		...
		for(var i = 0; i < productos.length; i++){
			...
			if(productos[i].stock > 0){
				...
				contenido+= '			<h2>'+productos[i].name+' <span class="price">$ '+productos[i].price+' </span></h2>'
